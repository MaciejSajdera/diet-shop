			...
			<div class="site-info">
				...
				<div class="site-footer__main">
					...
					<div class="col col-1">
							<h5> Lokalizacja </h5>
						<div id="map_wrapper">
						<div style="width: 100%"><iframe width="100%" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=al.%20Rzeczypospolitej%204/75,%20%2080-369%20Gda%C5%84sk+(JL%20Poradnia)&amp;t=&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
						</div>
					</div>
					...
					<?php
						$contact_data = get_field("contact_data", 34);
					?>
					...
					<div class="social-icons social-icons-footer">
						...
						<a href="<?php echo get_field("facebook_link", get_option( 'page_on_front' )) ?>" target="_blank" class="social-icons__icon social-icons-footer__icon">
						...
						<a href="<?php echo get_field("instagram_link", get_option( 'page_on_front' )) ?>" target="_blank" class="social-icons__icon social-icons-footer__icon fixed-ig-icon">
				...
				<div class="footer-bottom">
					...
					<a class="terms-link" href="<?php echo get_permalink(3129) ?>">Regulamin sklepu</a>
