			...
			<div class="site-info">
				...
				<div class="site-footer__main">
					...
					<div class="social-icons social-icons-footer">
						...
						<a href="" target="_blank" class="social-icons__icon social-icons-footer__icon">
						...
						<a href="" target="_blank" class="social-icons__icon social-icons-footer__icon fixed-ig-icon">
