...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header home__header" style="background-image: url('<?php echo $hero_image ?>'); background-repeat: no-repeat;">
				...
				<div class="page-menu__top">
						...
						<div class="shop-nav">
							...
							<a class="shop-nav__item button button__outline--green" href="<?php echo get_field('cta_header_link', get_option('page_on_front')); ?>">
										<span class="shop-nav__item-title">Zarezerwuj wizytę</span>	
										<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path fill="#fff" d="M17 10H7v2h10v-2zm2-7h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zm-5-5H7v2h7v-2z"/></svg>							</a>
							...
							?>
								<a class="myaccount-link-logged shop-nav__item button button__outline--green" href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>">
										<span class="shop-nav__item-title">Moje Konto</span>	
										<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
										<path d="M0 0h24v24H0V0z" fill="none"/><path fill="#fff" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
							...
							?>
								<a class="myaccount-link-unlogged shop-nav__item button button__outline--green" href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>">
										<span class="shop-nav__item-title">Zaloguj się</span>
										<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24"><g><rect fill="none" height="24" width="24"/></g><g><path fill="#fff" d="M11,7L9.6,8.4l2.6,2.6H2v2h10.2l-2.6,2.6L11,17l5-5L11,7z M20,19h-8v2h8c1.1,0,2-0.9,2-2V5c0-1.1-0.9-2-2-2h-8v2h8V19z"/></g></svg>
								</a>
								<?php
							endif;
							?> -->
								...
								<div class="social-icons">
										...
										<a href="https://www.facebook.com/venus.hurtownia" target="_blank" class="social-icons__icon">
										...
										<a href="https://www.instagram.com/venus_hurtowniakielce/" target="_blank" class="social-icons__icon fixed-ig-icon">
