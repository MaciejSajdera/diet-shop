...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header home__header" style="background-image: url('<?php echo $hero_image ?>'); background-repeat: no-repeat;">
		<nav id="site-navigation" class="main-navigation <?php if ($isActive == 1) : echo 'promo-navigation'; else : echo 'promo-navigation-off'; endif; ?>">
						...
						<div class="shop-nav">
							...
							<a class="shop-nav__item button button__outline--green" href="<?php echo get_field('cta_header_link', get_option('page_on_front')); ?>">
								...
								<div class="social-icons">
										...
										<a href="<?php echo get_field("facebook_link", get_option( 'page_on_front' )) ?>" target="_blank" class="social-icons__icon">
										...
										<a href="<?php echo get_field("instagram_link", get_option( 'page_on_front' )) ?>" target="_blank" class="social-icons__icon fixed-ig-icon">
