...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-content">
		...
		the_content(
			sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'poradnia' ),
					array(
						'span' => array(
							'class' => array(),
						),
		...
		wp_link_pages(
			array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'poradnia' ),
				'after'  => '</div>',
			)
		);
		?>
		</div>
		<?php poradnia_post_thumbnail(); ?>
	</div><!-- .entry-content -->
